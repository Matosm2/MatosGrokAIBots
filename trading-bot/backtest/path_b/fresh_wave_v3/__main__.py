"""CLI: python -m backtest.path_b.fresh_wave_v3 [--refresh] [--tfs ...]"""
...
from backtest.path_b.fresh_wave_v3.sweep import run_fresh_wave_v3, write_scoreboard
...
def main() -> None:
    ...
    results = run_fresh_wave_v3(years=args.years, refresh=args.refresh, tfs=tfs)
